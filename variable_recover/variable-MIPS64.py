...
def main(argv):
    ...
    file_name = "rm"
    file_path = "/home/qinfan/coreutils/coreutils-MIPS64/src/" + file_name  # MIPS64

    # MIPS64 save_path:
    MIPS64_path = '/home/qinfan/PycharmProjects/angr/MIPS64-var-texts/' + file_name + ".txt"
    if os.path.exists(MIPS64_path):
        print('{} already exists, removed!'.format(MIPS64_path))
        os.remove(MIPS64_path)
