...
def main(argv):
    ...
    file_name = "comm"
    file_path = "/home/qinfan/coreutils/coreutils-MIPS32/src/" + file_name  # MIPS32

    # MIPS32 save_path:
    MIPS32_path = '/home/qinfan/PycharmProjects/angr/MIPS32-var-texts/' + file_name + ".txt"
    if os.path.exists(MIPS32_path):
        print('{} already exists, removed!'.format(MIPS32_path))
        os.remove(MIPS32_path)
